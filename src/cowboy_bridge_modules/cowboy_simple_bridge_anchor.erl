...
init(Req, State) ->
	...
	trace_utils:debug_fmt( "Initialising cowboy_simple_bridge_anchor with:~n"
		" - Req = ~p~n - State = ~p", [ Req, State ] ),

	% Lighter:
	%trace_utils:debug_fmt( "Initialising cowboy_simple_bridge_anchor with "
